...
export default function Home() {
  return (
    <div className="mx-auto w-full max-w-6xl">
      <div className="grid grid-rows-[4em_auto_4em] min-h-screen">
        ...
        <main className="p-2">
          ...
          <p className="text-center mx-auto w-[32em] pt-5">
            {config.intro}
          </p>
          ...
          <ul className="flex space-x-8 justify-center mx-auto pt-5 text-lg">
            <li>
              <a
